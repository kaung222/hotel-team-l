      ...
      <div className=" overflow-hidden">
        ...
        <div data-aos="fade-up" data-aos-duration="3000" className="">
          <section className=" bg-[#F8F5F0] w-[450px] sm:w-full">
            <div className=" pt-2 md:pt-10 mb-20">
          ...
          <section className="w-[450px] sm:w-full bg-black">
            ...
            >
              <div className=" text-white text-center p-32">
                <p className=" md:text-xl mb-7 hero">ROOMS</p>
                <h1 className=" text-xl md:text-5xl hero">Our Rooms & Suites</h1>
              </div>
              <div className="">
                <div className=" grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3">
                    <RoomCard title={'Premiere Deluxe Room'} imgSrc={'https://envato.bdevs.net/royel/wp-content/uploads/2023/05/2.jpg'} />
                    <RoomCard title={'Superior Site Room'} imgSrc={'https://envato.bdevs.net/royel/wp-content/uploads/2023/05/5-2.jpg'} />
                    <RoomCard title={'Master Suite Room'} imgSrc={'https://envato.bdevs.net/royel/wp-content/uploads/2023/05/4-2.jpg'} />
                    <RoomCard title={'Junior Site Room'} imgSrc={'https://envato.bdevs.net/royel/wp-content/uploads/2023/05/3.jpg'} />
                    <RoomCard title={'Couple Sea View Room'} imgSrc={'https://envato.bdevs.net/royel/wp-content/uploads/2023/05/2.jpg'} />
                    <RoomCard title={'Queen Deluxe Rooms'} imgSrc={'https://envato.bdevs.net/royel/wp-content/uploads/2023/05/1-3.jpg'} />
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="md:mb-[200px]">
            <div className="">
              <div className=" text-start lg:text-center mx-5 mt-32">
                ...
                <div className=" mt-10 text-xl lg:text-5xl hero mx-auto mb-20 tracking-wider block lg:flex items-center justify-center">
                  <h2 className="me-2">
