      ...
      <div className="px-5 py-3 flex items-center z-30 justify-between bg-slate-50">
        ...
        <div className="hidden md:flex items-center justify-center gap-7">
          ...
          <Link className="flex items-center justify-center px-3 py-2 gap-2 group 0">
            ...
            <ul className=" bg-slate-50 ml-7 hidden group-hover:block animate__fadeInUp animate__animated p-3 pt-10 duration-500 w-[200px] top-[50px] absolute ">
          ...
          <Link className="flex items-center justify-center px-3 group py-2 gap-2 ">
            ...
            <IoIosArrowDown className="group-hover:text-yellow-500" />
            <ul className="hidden bg-slate-50 ml-7 group-hover:block animate__fadeInUp animate__animated transition-all p-3 pt-7 duration-500 w-[200px] top-[50px] absolute  ">
              <Link to="/shop">
                <li className=" px-3 py-1 hover:ml-5 transition-all hover:text-yellow-500">
                  SHOP
                </li>
