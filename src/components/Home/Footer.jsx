...
const Footer = () => {
  return (
    <>
      <div className=" grid grid-cols-10 gap-10 px-5 py-20 bg-gray-800 h-full border-b border-slate-500">
        <div className=" flex flex-col col-span-3 gap-10 ">
          <h4 className=" text-white text-3xl font-serif">About Us</h4>
        ...
        <div className=" flex flex-col col-span-2 gap-10">
          <h4 className=" text-white text-3xl font-serif">Useful Link</h4>
        ...
        <div className=" flex flex-col col-span-2 gap-10 ">
          <h4 className=" text-white text-3xl font-serif">Contact Us</h4>
        ...
        <div className="flex flex-col col-span-3 gap-10">
          <h4 className=" text-white text-3xl font-serif">Newsletter</h4>
          <p className=" text-white font-serif">
          ...
          <div className=" input-group">
            <input
              type="email"
              className=" px-4 py-4 border border-slate-500 bg-transparent text-white"
              placeholder="Your Email"
            />
            <button className="px-4 py-4 border border-orange-200 bg-orange-200">
              <BsArrowUpRight />
            </button>
          </div>
        </div>
      ...
      <div className=" px-5 py-4 bg-gray-800 h-full">
        <p className=" text-white text-center font-serif">
          &copy; 2023 Royel All Rights Reserved
        </p>
      </div>
    </>
  );
